...
@ConfigNode
@Comment("Storage GUI configuration")
public interface StorageGuiConfig extends GuiConfig {

    @Comment("GUI settings")
    @ConfigPath(value = "Settings", priority = 0)
    StorageSettingsConfig settings();
    ...
    default Map<String, Object> representItem() {
        ...
        map.put("Lore", java.util.Arrays.asList(
                ...
                "",
                "&8[&6Left Click&8] &7Withdraw one item.",
                "&8[&6Right Click&8] &7Withdraw a stack.",
                "&8[&6Shift Left&8] &7Withdraw all.",
                "&8[&6Shift Right&8] &7Add all to storage."
        ));
    ...
    StorageControlItemsConfig controlItems();
    ...
    @ConfigNode
    interface StorageSettingsConfig extends SettingsConfig {
    ...
    @ConfigNode
    @Comment("Control items for the storage GUI")
    interface StorageControlItemsConfig extends ControlItemsConfig {
        ...
        default Map<String, Object> about() {
            ...
            map.put("Lore", Arrays.asList(
                    ...
                    "",
                    "&8[&6ᴄʟɪᴄᴋ&8] #dcdde1Change storage status."
            ));
            map.put("Slot", 50);
            return map;
        }
