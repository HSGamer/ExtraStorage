...
public interface StorageGuiConfig {
    ...
    interface SettingsConfig {
        ...
        default String title() { return "§0ʏᴏᴜʀ sᴛᴏʀᴀɢᴇ"; }
    ...
    interface StorageRepresentItemConfig extends ItemConfig {
    ...
    StorageRepresentItemConfig representItem();
